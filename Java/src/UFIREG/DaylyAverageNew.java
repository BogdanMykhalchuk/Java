...
/**
 * Created by Bogdan on 17.10.2016.
 */

public class DaylyAverageNew {

    private static int dayOfMonth;
    private static String datePattern;
    /** pattern of the name of the file: "UFIREG_Myy" (Locale.US)) M - month, yy - year;*/
    private static String inputFilePath = "D:\\Bogdan\\Job\\Java\\Kolya\\Hub\\" +
            "Bogdan\\src\\com\\company\\UFIREG\\UFIREG_0814.txt";
    ...
    public static void main(String[] args) {
        ...
        try {
            String outputFilePath = "D:\\Bogdan\\Job\\Java\\Kolya\\Hub\\" +
                    "Bogdan\\src\\com\\company\\UFIREG\\Test.Test.txt";
    ...
    private static void setDayOfMonth(int dayOfMonth) {
        DaylyAverageNew.dayOfMonth = dayOfMonth;
    }
