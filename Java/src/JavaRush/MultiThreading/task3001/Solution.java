package JavaRush.MultiThreading.task3001;
...
public class Solution {
    ...
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        ...
        BigInteger value = new BigInteger(number.getDigit(),
                number.getNumerationSystem().getNumerationSystemIntValue());

        Number result = new Number(expectedNumerationSystem,
                value.toString(expectedNumerationSystem.getNumerationSystemIntValue()));
        return result;
    }
}
